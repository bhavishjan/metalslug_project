...
public:
    Eri() : Player() {
		...
		EriTexLeft.loadFromFile("Sprites/Eri/EriLeft.png");
		EriTexRight.loadFromFile("Sprites/Eri/EriRight.png");
...
public:
    Fiolina() : Player() {
		...
		FiolinaTexLeft.loadFromFile("Sprites/Fiolina/FiolinaLeft.png");
		FiolinaTexRight.loadFromFile("Sprites/Fiolina/FiolinaRight.png");
